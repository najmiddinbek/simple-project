...
export async function POST(request) {
    const { shaxs, maktab, sinf, pupil, shaxsiy, newSinfi, newDarsQoldirish, telephoneRaqami, newIsm } = await request.json();
    await connectMongoDB();
    await Mavzular.create({ shaxs, maktab, sinf, pupil, shaxsiy, newSinfi, newDarsQoldirish, telephoneRaqami, newIsm });
